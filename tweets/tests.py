...
class TweetTestCase(TestCase):
    def setUp(self):
        self.user = User.objects.create_user(username='first_user', password="somepassword")
        self.userb = User.objects.create_user(username='second_user', password="somepassword2")
